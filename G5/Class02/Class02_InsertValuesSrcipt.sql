...
insert into dbo.Employees(FirstName,LastName,DateOfBirth,Gender,HireDate,NationIdNumber)
...
update e set DateOfBirth = dateadd(MM,Id,DateOfBirth),  
			 ...
			 NationIdNumber =  id + cast(10000000 * rand(id*10) as int)
...
insert into dbo.Customers (Name, AccountNumber, City,Region, isActive)
